import "./styles.css";
import {root, pages, getCardDom, addPopOver} from "./dom.js";
...
function manageNoteClick(note, classOfNote, page) {
...
function detectTheIcon(id, icon) {
